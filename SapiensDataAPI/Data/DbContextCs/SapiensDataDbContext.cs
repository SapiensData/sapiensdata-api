...
{
	public class SapiensDataDbContext : IdentityDbContext<ApplicationUser>
	{
		private readonly IEncryptionProvider _provider;

		public SapiensDataDbContext(GlobalVariableService globalVariableService)
		{
			_provider = new EncryptionProvider(globalVariableService);
		}

		public SapiensDataDbContext(DbContextOptions<SapiensDataDbContext> options, GlobalVariableService globalVariableService)
			: base(options)
		{
			_provider = new EncryptionProvider(globalVariableService);
		}
